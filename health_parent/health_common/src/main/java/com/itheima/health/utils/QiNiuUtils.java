...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "fvO_RL3CtB4lNPoF1nRAU5NzgPhGU-SO2yVtJb4D";
    private static final String SECRETKEY = "YLNNSPJ-qwHQci4CE0KhNS_mypUH_D1mALma0z9H";
    private static final String BUCKET = "szhm";
    public static final String DOMAIN= "http://qgzwvfv0u.hn-bkt.clouddn.com/";

    public static void main(String[] args) {
       // uploadFile("C:\\Users\\Administrator\\Desktop\\222.jpg","dog.jpg");
